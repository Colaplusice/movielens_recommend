...
class Movie(models.Model):
    ...
    name = models.CharField(verbose_name="电影名称", max_length=128, unique=True)
    num = models.IntegerField(verbose_name="浏览量", default=0)
    pic = models.FileField(verbose_name="封面图片", max_length=256, upload_to='movie_cover')
...
class Num(models.Model):
    ...
    rates = models.FloatField(verbose_name="评分汇总", default=0)
